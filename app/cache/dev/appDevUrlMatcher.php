...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // imerir_noyau_homepage
        if (rtrim($pathinfo, '/') === '') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'imerir_noyau_homepage');
            }

            return array (  '_controller' => 'Imerir\\NoyauBundle\\Controller\\SoapController::indexAction',  '_route' => 'imerir_noyau_homepage',);
        }
        ...
        // _webservice_call
        if (preg_match('#^/(?P<webservice>[^/]++)$#s', $pathinfo, $matches)) {
            if ($this->context->getMethod() != 'POST') {
                $allow[] = 'POST';
