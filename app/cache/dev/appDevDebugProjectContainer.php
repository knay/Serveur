...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'soap_service' => 'getSoapServiceService',
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/Imerir/NoyauBundle/Entity'))), 'Imerir\\NoyauBundle\\Entity');
        $b->addDriver($a, 'FOS\\UserBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('ImerirNoyauBundle' => 'Imerir\\NoyauBundle\\Entity', 'FOSUserBundle' => 'FOS\\UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_46f925096411bb59a3decfbc9eb1e1108bfe767141ae4fe5da2f1afd73725897');
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Imerir\\NoyauBundle\\Entity\\Utilisateur');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Imerir\\NoyauBundle\\Entity\\Utilisateur');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Imerir\\NoyauBundle\\Entity\\Utilisateur');
    }
    ...
    /**
     * Gets the 'soap_service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Imerir\NoyauBundle\Services\SoapService A Imerir\NoyauBundle\Services\SoapService instance.
     */
    protected function getSoapServiceService()
    {
        return $this->services['soap_service'] = new \Imerir\NoyauBundle\Services\SoapService($this);
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Imerir/NoyauBundle/Resources/views'), 'ImerirNoyau');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'fos_user.model.user.class' => 'Imerir\\NoyauBundle\\Entity\\Utilisateur',
